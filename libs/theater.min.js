function Typer (element, options, scenes) {
  ...
  var defaultOptions = { newline: 60, type: 15, break: 1000 };
  ...
  // instead of the element's innerHTML as
  ...
  function type () {
    ...
    if (state === scene) {
      // so make a break and then newline the content
      return setTimeout(newline, config.break);
    }
    ...
    // or just call the newline function
  ...
  function stop () {
    // as you've seen through newline and type
