muonApp.controller('HowTo2Ctrl', function ($scope, $stateParams) {
    ...
    var playerTwo = Typer(stepTwo, ['The glowing green (Muon) and blue (Anti-muon) quadrants are the effects of radiation on that quadrant. In order to be able to win in your home quadrant, you must move all peices completely out of the quadrant, to deplete the radiation.']);
