muonApp.controller('helpBoardAndUICtrl', function ($scope, $stateParams, $state) {
    ...
    var slideText = [
                    ...
                    ,'This is the game menu. You can hover over each of the buttons to see what they do.'    
                    ,'These are the stats. The top bar shows how many moves have been made. The bottom bar is the turn indicator.'    
                    ]
